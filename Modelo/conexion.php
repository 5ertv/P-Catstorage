...
class Conexion{
    ...
    private $db = "catstorage_inventory";
    private $puerto = 3306;
    ...
    function __construct(){
        $this->pdo = new PDO("mysql:dbname={$this->db};host={$this->server};port={$this->puerto};charset={$this->charset}",$this->usuario,$this->contrasena,$this->atributos);
