                    ...
                    <div class="card-body p-0">
                            ...
                            <div class="datos_cp">
                                <div class="form-group row">
                                    ...
                                    <div class="input-group-append col-md-6">
                                        <input type="text" onkeydown="return soloLetras(event)" class="form-control" id="cliente" placeholder="Ingresa nombre" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <span>RUT: </span>
                                    <div class="input-group-append col-md-6">
                                        <input type="text" class="form-control" id="rut" onkeypress="return rut(event);" minlength="8" maxlength="9" placeholder="Ingresar RUT sin puntos ni guion" required minlength="9"> 
                                    </div>
                                    <button type="button" id="btn-validar" class=" btn btn-danger">Validar Rut</button>  
                                </div>
                                    <div>
                                        <p id="resultado"></p>
                                    </div>
                                <div class="form-group row">
                                    <span>Vendedor: </span>
                                    <h3><?php echo $_SESSION['n_y_ap'];?></h3>
                                </div>
                            </div>
                        </header>
                        ...
                        <div class="row justify-content-between">
                            <div class="col-md-4 mb-2">
                                <a href="../vista/admin_cat.php" class="btn btn-primary btn-block">Seguir comprando</a>
                            </div>
