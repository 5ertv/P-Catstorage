        ...
        $.post('../controlador/LoteController.php',{consulta,funcion},(response)=>{
            ...
            lotes.forEach(lote=>{
                ...
                if (lote.tipo=='Alimentos') {
                  ...
                  <i class="fas fa-lg fa-cubes"></i>${lote.stock}
                  </div>
                    ...
                    <div class="row">
                      <div class="col-7">
                        ...
                        <ul class="ml-4 mb-0 fa-ul">
                          <li class="small"><span class="fa-li"><i class="fa-solid fa-comment"></i></span> Descripcion: ${lote.descripcion}</li>
                          <li class="small"><span class="fa-li"><i class="fa-solid fa-tag"></i></span> Categoria: ${lote.tipo}</li>`
                          if(lote.tipo=='Alimentos'){
                              template+=`
                              <li class="small"><span class="fa-li"><i class="fa-solid fa-calendar-times"></i></span> Vencimiento: ${lote.vencimiento}</li>
